...
def plotting_weather():
    ...
    plt.scatter(broken_min, tmin_15.iloc[broken_min], s = 50, c = 'black', label = '2015 Broken Low')
    plt.scatter(broken_max, tmax_15.iloc[broken_max], s =50, c = 'm', label = '2015 Broken High')
    ...
    fig.savefig('plotting_weather_patterns.png', dpi=100)
    plt.show()
